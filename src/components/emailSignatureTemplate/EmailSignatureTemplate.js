...
const EmailSignatureTemplate = ({ data }) => {
  ...
  const downloadImage = () => {
    const node = signatureCardRef.current;
      html2canvas(node, { scrollX: 0, scrollY: -window.scrollY }).then(
        function (canvas) {
    ...
    <>
      <div
        ...
        className={`signature-card ${
          hasPersonalNumber || hasBookingLink ? "has-additional-fields" : ""
        }`}
      >
        ...
        <Card className="right-half">
          <Card.Body>
            ...
            <div className="social-media-icons">
              <a
                href="https://www.facebook.com/ThriveFuel/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/thrivefuel/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FontAwesomeIcon
              ...
              <a
                href="https://www.tiktok.com/@thrivefuel"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FontAwesomeIcon
              ...
              <a
                href="https://www.linkedin.com/company/thrivefuel/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FontAwesomeIcon
              ...
              <a
                href="https://twitter.com/thrivefuel"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FontAwesomeIcon
              ...
              <a
                href="https://youtube.com/@thrivefuel6698"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FontAwesomeIcon
